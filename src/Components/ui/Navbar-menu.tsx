...
export const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    <div onMouseEnter={() => setActive(item)} onClick={() => setActive(null)} className="relative cursor-pointer">
      <motion.p
...
export const HoveredLink: React.FC<HoveredLinkProps> = ({ children, href = "#", className = "", ...rest }) => {
  return (
    <Link
      href={href}
